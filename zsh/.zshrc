...
# export RUST_HOME='/Users/$(whoami)/.cargo'
...
export VOLTA_HOME='/Users/$(whoami)/.volta'
...
# InfluxDB: 时序数据库工具
# export PATH="/Users/$(whoami)/.influxdb/:$PATH"
...
# [[ -f "/Users/$(whoami)/.openclaw/completions/openclaw.zsh" ]] && \
#  source "/Users/$(whoami)/.openclaw/completions/openclaw.zsh"
